...
MemberVFuncThunk<      CBasePlayer *, bool, const CBasePlayer *, const CUserCmd *, const CBitVec<MAX_EDICTS> *> CBasePlayer::vt_WantsLagCompensationOnEntity(TypeName<CBasePlayer>(), "[classified]CBasePlayer::WantsLagCompensationOnEntity");
